...
function calc() {
  ...
  if (blRef < 5) { alert('Le critère de refus doit être supérieur ou égal à 5 coups/10 cm.'); return; }
  ...
  /* Validation critère de refus */
  if (blRef < 5) {
    alert('Le critère de refus (' + blRef + ' coups/10 cm) est trop faible (minimum 5).\nValeur recommandée pour Zone II : 61 coups/10 cm.');
    return;
  }
  if (blRef > 250) {
